...
current_line = 1
# My question about this is to confirm that readline "marks its place" at the end of each line it reads, starting again at the beginning of the next line. Based on documentation at link above, it *seems* that it does this, but it isn't really explicit
