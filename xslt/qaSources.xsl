...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="qaLink">
        <xsl:param name="node"/>
        <xsl:choose>
            <xsl:when test=". = 'urn:ld4p:qa:names'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:names:person'">
                <a href="http://id.loc.gov/authorities/names.html">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:names:organization'">
                <a href="http://id.loc.gov/authorities/names.html">
            ...
            <xsl:when test=". = 'urn:ld4p:sinopia'">
                <xsl:text>Sinopia resources</xsl:text>
            </xsl:when>
            <xsl:when test=". = 'urn:ld4p:qa:genres'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:gettyaat'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:subjects'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:demographics'">
            ...
            <xsl:when test=". = 'https://www.rdaregistry.info/termList/RDAColourContent/'">
                <a href="https://www.rdaregistry.info/termList/RDAColourContent/">
                    <xsl:text>RDA Colour Content</xsl:text>
                </a>
            </xsl:when>
            <xsl:when test=". = 'urn:ld4p:qa:names:geographic'">
                <a href="http://id.loc.gov/authorities/names.html">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:dbpedia'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:isni'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:fast:work'">
            ...
            <!-- See *Q1* -->
            <xsl:when test=". = 'https://id.loc.gov/vocabulary/mrelief'">
                <a href="https://id.loc.gov/vocabulary/mrelief">
                    <xsl:text>Relief (LC Linked Data Service)</xsl:text>
                </a>
            </xsl:when>
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:colour_content'">
                <a href="https://www.rdaregistry.info/termList/RDAColourContent/">
                    <xsl:text>RDA Colour Content</xsl:text>
                </a>
                <xsl:copy-of select="$viaQaText"/>
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:form_of_tactile_notation'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:content_type'">
            ...
            <xsl:when test=". = 'https://id.loc.gov/vocabulary/mprojection'">
                <a href="https://id.loc.gov/vocabulary/mprojection">
                    <xsl:text>Projection (LC Linked Data Service)</xsl:text>
                </a>
            </xsl:when>
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:aspect_ratio'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:performance'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:material'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:bibliographic_format'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:file_type'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:type_of_recording'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:groove_pitch'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:groove_width'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:production_method'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:carrier_type'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:mode_of_issuance'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:media_type'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:config_playback_channels'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:polarity'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:presentation_format'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:names:family'">
                <a href="http://id.loc.gov/authorities/names.html">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:regional_encoding'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:recording_medium'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:track_config'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:special_playback'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:broadcast_standard'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:layout'">
            ...
            <xsl:when test=". = 'urn:ld4p:qa:rda_registry_ld4l_cache:video_format'">
            ...
            <xsl:when test=". = 'https://id.loc.gov/vocabulary/menclvl'">
                <a href="https://id.loc.gov/vocabulary/menclvl">
                    <xsl:text>MARC Encoding Level List (LC Linked Data Service)</xsl:text>
                </a>
            </xsl:when>
            <xsl:when test=". = 'https://id.loc.gov/vocabulary/descriptionConventions'">
            ...
            <xsl:when test=". = 'https://id.loc.gov/vocabulary/marcauthen'">
